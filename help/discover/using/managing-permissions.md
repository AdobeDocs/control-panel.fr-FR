...
1. La liste des **[!UICONTROL Profils de produit]** de l’instance sélectionnée s’affiche. Cliquez sur le profil de produit **[!UICONTROL Administrateurs]** pour accéder à la liste des utilisateurs administrateurs.
   ...
   >
   >Examinez attentivement les conventions de dénomination de votre profil de produit dans Admin Console pour vous assurer que seules les personnes autorisées disposent d’un accès au panneau de contrôle. Cela permet en effet d’apporter des modifications importantes aux instances Campaign.
...
>[!VIDEO](https://video.tv.adobe.com/v/34775?captions=fre_fr&quality=12)
