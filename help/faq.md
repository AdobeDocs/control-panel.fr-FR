...
description: Questions courantes relatives au Panneau de configuration
...
Vous pouvez aussi démarrer **Admin Console**. Votre ID d’organisation IMS sera visible dans votre URL ; il devrait ressembler à quelque chose comme : https://adminconsole.adobe.com/xxx@AdobeOrg/overview.

**Pourquoi ai-je besoin de connaître mon identifiant de l'organisation IMS ?**


Afin que vous puissiez gérer les paramètres de votre instance, nous voulons vous assurer que vous obtenez les informations appropriées pour la bonne instance au cas où vous utiliseriez plusieurs instances pour votre entreprise.
...
1. Récupérez votre URL de connexion. S'il s'agit de l'URL que vous utilisez pour vous connecter à votre instance Campaign, elle doit se terminer par ".campaign.adobe.com".
1. Ouvrez le terminal, puis exécutez une opération **nslookup** sur votre URL de connexion.
...
Le Panneau de configuration vous permet de surveiller le stockage, les adresses IP des listes blanches et de gérer les clés SSH de vos serveurs SFTP en fonction de vos besoins et d'autres actions.

Pour plus d’informations, voir la documentation sur les actions prises en charge par le Panneau de configuration.
...
Suivez les instructions détaillées de la documentation du Panneau de configuration.
